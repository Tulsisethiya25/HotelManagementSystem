...
public class RoomServiceImpl implements RoomService {
	...
	public String addRoom(RoomDto roomdto) {
			Room room = new Room(roomdto.getRoomNumber(), roomdto.getType(), roomdto.getNoOfPerson(),
					roomdto.getPrice(), roomdto.getRoomStatus());
			roomRepository.save(room);
			log.info("Room details add successfully");
			return "Room details add successfully";
		}
